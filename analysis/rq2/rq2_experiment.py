...
SCRIPT_DIR = Path(__file__).resolve().parent  # analysis/rq2
...
RESULTS_DIR = PROJECT_ROOT / "results" / "rq2"
DATA_DIR = RESULTS_DIR / "data"
CSV_DIR = RESULTS_DIR / "csvs"
IMAGES_DIR = RESULTS_DIR / "images"

# Cross-model comparison output
CROSS_MODEL_CSV_PATH = CSV_DIR / "rq2_cross_model_summary.csv"
...
def get_model_paths(model_tag: str) -> tuple[Path, Path, Path, Path, Path]:
    ...
    data_path = DATA_DIR / sanitized / "rq2_vram_raw.csv"
    summary_csv_path = CSV_DIR / sanitized / "rq2_summary.csv"
    summary_tex_path = CSV_DIR / sanitized / "rq2_summary_table.tex"
    fit_plot_path = IMAGES_DIR / sanitized / "rq2_predicted_vs_measured.png"
    error_plot_path = IMAGES_DIR / sanitized / "rq2_errors.png"
...
def write_latex_table(
    ...
    lines.append(r"\label{tab:rq2-vram-summary}")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="RQ2 VRAM validation: sweep, measure, analyse, one shot"
    )
    parser.add_argument(
...
def migrate_existing_results():
    ...
    old_data_path = DATA_DIR / "rq2_vram_raw.csv"
    old_summary_path = CSV_DIR / "rq2_summary.csv"
    old_tex_path = CSV_DIR / "rq2_summary_table.tex"
    old_fit_plot = IMAGES_DIR / "rq2_predicted_vs_measured.png"
    old_error_plot = IMAGES_DIR / "rq2_errors.png"
...
def main() -> None:
    ...
    if args.all_quants:
        ...
        csv_path = CSV_DIR / "rq2_cross_model_summary.csv"
